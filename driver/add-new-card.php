            ...
            <div class="scan-your-card-container-none">
                ...
                <div class="scan-your-card-prompt">
                    <div class="position-relative scan-your-card-icon">
                        ...
                        <img class="img-responsive w-100 photocamera-icon" src="../icons/photocamera.svg" alt="Camera Icon">
                ...
                <div class="card-info-container font-weight-light">
                    ...
                    <div class="float-right">
                        ...
                        <input class="card-info-cvv font-weight-light" value="456" type="tel" name="cvv" maxlength="5">
                    </div>
                ...
                <div class="card-info-container font-weight-light">
                    <div class="card-number">
                        <div class="form-group">
                            <label class="width-100 label-title">
                                Card Holder Name
                                <input class="input-group" type="text" autocomplete="off" value="Jonathan McBerly" placeholder="Card Holder Name">
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="btn-save">
                    <a href="credit-cards.php" class="btn btn-primary">Save Card <span class="far fa-save"></span></a>
                </div>
            </div>
        </div>
    </div>
