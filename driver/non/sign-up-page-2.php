                    ...
                    <form class="width-100">
                        <div class="form-group">
                            <div class="input-group border-bottom">
                                <input style="margin-left: 0;" class="form-control verify-sms" type="tel" name="username" placeholder="----" maxlength="4">
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="form-submit-button">
                            <a href="successful-verification.html" class="btn btn-primary text-uppercase verify-btn">Verify</a>
                        </div>
                    </form>
                </div>
                <!--Verification Code Container Start-->
