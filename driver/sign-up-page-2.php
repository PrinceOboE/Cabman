        ...
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="rest-container">
                ...
                <div class="sign-up-form-container text-center">
                    <form class="width-100" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            if (isset($_POST['create_user'])) {
                                $select = mysqli_query($connection, "SELECT `pnumber` FROM `userd` WHERE `pnumber` = '" . $_POST['phone'] . "'") or exit(mysqli_error($connection));
                    ...
                    <!--Rate Text Constainer Start-->
                    <!-- <p class="regular-link">Already have an account? <a href="sign-in.php">Sign in</a></p> -->
                </div>
