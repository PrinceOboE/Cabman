            ...
            <div class="rest-container">
                ...
                if (isset($_POST['create_user'])) {
                    ...
                    if ($user_password == $passwordconirmaion) {
                        $select = mysqli_query($connection, "SELECT `email_address` FROM `userd` WHERE `email_address` = '" . $_POST['email'] . "'") or exit(mysqli_error($connection));
                ...
                ?>
                        ...
                        <?php
                            ...
                            // $query = "INSERT INTO userd(unique_id,fname, profileimg, user_date, user_type, user_password, email_address, gender, user_address, lname, pnumber, status) ";
                            ...
                            //     setcookie("username", "$lastname", time() + 3600 * 24 * 7 * 4 * 12, "/");
                                ...
                                header("Location: drivers-license.php");
                            // }
                        } else {
