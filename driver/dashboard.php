            ...
            <div class="rest-container">
                <div class="all-wide-container trip-history-driver-container">
                    ...
                    <div class="all-sales-history-items">
                        ...
                        <div class="">
                            <button style="background: green;" type="button" class="btn btn-dark text-uppercase mb-3">Fund your Wallet</button>
                            <button style="background: green;" type="button" class="btn btn-dark text-uppercase">Withdraw to Bank Account</button>
                        </div>
