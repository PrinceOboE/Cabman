...
if (isset($_POST['create_user'])) {
    ...
    if ($user_password == $passwordconirmaion) {
        ...
        $query = "INSERT INTO userd(username, user_date, user_type, user_password, email_address) ";
        $query .= "VALUES('{$username}',now(),'{$user_role}','{$user_password}','{$user_email}') ";
                ...
                <div class="sign-up-form-container text-center">
                    <form class="width-100" action="" method="post" enctype="multipart/form-data">
                        ...
                        <!--Sign Up Input Field End-->
                                    ...
                                    <span style="color: red;">Passwords do not match. Please verify.</span>
                        ...
                        <input type="submit" class="btn btn-primary text-uppercase col-12" name="create_user" value="Sign Up with Email">
