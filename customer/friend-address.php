...
<div class="row h-100">
    <div class="col-xs-12 col-sm-12">
        ...
        <div class="header-icons-container text-center">
            ...
            <span>My Address / My Friend Laura</span>
            <a href="#">
        ...
        <div class="rest-container">
            ...
            <div class="address-title">My Friend Laura</div>

            <!-- Fill In Friend's Address Start-->
            <div class="sign-up-form-container text-center">
                <form class="width-100">
                    ...
                    <div class="form-submit-button">
                        <a href="addresses.php" class="btn btn-dark text-uppercase font-weight-normal">Save <span class="far fa-save save-icon"></span></a>
                    </div>
                </form>
            </div>
            <!-- Fill In Friend's Address End-->
