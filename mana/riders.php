                        ...
                        <table class="table table-advance table-hover">
                            <tbody>
                                <tr>
                                    ...
                                    <th><i class="icon_status"></i> Status</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-success" href="riders.php?approved=<?php echo $db_unique_id ?>"><i class="icon_check_alt2"></i></a>
                                                    <a class="btn btn-danger" href="riders.php?unapproved=<?php echo $db_unique_id ?>"><i class="icon_close_alt2"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                <?php
                                ...
                                if (isset($_GET['approved'])) {
                                    ...
                                    $query = "UPDATE users SET state = 'approved' WHERE unique_id = {$the_users_id}  ";
