            ...
            <div class="profile-widget profile-widget-info">
              <div class="panel-body">
                ...
                <div class="col-lg-4 col-sm-4 follow-info">
                  <p>Hello I’m <?php echo $_SESSION['firstname']." ".$_SESSION['lastname']  ?>, a leading expert in interactive and creative design.</p>
                  <p>@jenifersmith</p>
                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <form class="form-horizontal" role="form">
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="f-name" placeholder="<?php echo $_SESSION['firstname'] ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Last Name</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="l-name" placeholder="<?php echo $_SESSION['lastname'] ?>">
                            </div>
                          </div>
                          <div class="form-group">
